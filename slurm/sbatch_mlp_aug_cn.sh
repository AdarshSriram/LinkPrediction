...
#SBATCH -o results/aug/CN/%j.log  # Name of stdout output file (%j expands to jobId)
#SBATCH -e results/aug/CN/aug_cmn.err  # Name of stderr output file
...
python3 models.py --dataset collab --model gcn --embedding-aug cn
